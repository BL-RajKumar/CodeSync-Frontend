...
import { LogOut, Code2, User as UserIcon, Search, Bell } from 'lucide-react';
...
const Navbar = () => {
  ...
  // Click outside handler for closing the notification dropdown
  useEffect(() => {
          ...
          {user ? (
            <>
              ...
              {user && user.role === 'Admin' && (
                <>
                  <Link to="/admin/users" className="text-muted font-medium hover:text-main transition-colors duration-150">Admin: Users</Link>
                  <Link to="/admin/sessions" className="text-muted font-medium hover:text-main transition-colors duration-150">Admin: Sessions</Link>
                </>
              )}
