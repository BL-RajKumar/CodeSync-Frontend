...
const Button = ({ children, onClick, type = 'button', variant = 'primary', fullWidth, disabled }) => {
  ...
  const variants = {
    primary: "bg-primary text-white shadow-sm hover:bg-primary-hover hover:-translate-y-[1px] hover:shadow-md",
    secondary: "bg-white/5 text-main border border-border hover:bg-white/10",
